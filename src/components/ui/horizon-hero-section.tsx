...
export const HorizonHeroSection: React.FC<HorizonHeroProps> = ({ onScrollEnd }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Trigger callback when scroll reaches end
      if (progress >= 0.99 && onScrollEnd) {
        onScrollEnd();
      }
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="scroll-sections">
        {[...Array(2)].map((_, i) => {
          ...
          } as Record<number, { line1: string; line2: string }>;
